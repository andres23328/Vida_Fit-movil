...
const DeadlineLoader = () => {
      ...
      <script>
        ...
        <div id="deadline">
          ...
          <div class="deadline-days">
            Cargando <span class="day">7</span> <span class="days">days</span>
          </div>
        </div>
      </body>
    </html>
  ...
  return (
    <Animatable.View
      ...
      duration={2000}
      delay={2000}
      style={{ width: 150, height: 150, alignItems: 'center', justifyContent: 'center', marginTop: -80 }}
    >
      <WebView
        originWhitelist={['*']}
